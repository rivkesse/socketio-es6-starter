...
var UploadObj = {
    getTintedImages: function getTintedImages() {
    ...
    upload_avatar_to_s3: function upload_avatar_to_s3(avatar, filename) {
        var base = avatar.replace(/^data:image\/\w+;base64,/, "");
        var buf = new Buffer(base, 'base64');
        return upload_file_to_s3(buf, filename);
    },
    upload_file_to_s3: function upload_file_to_s3(base64data, filename) {
        return new q.Promise(function (resolve, reject) {
